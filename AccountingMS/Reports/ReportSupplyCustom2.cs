...
namespace AccountingMS
{
    public partial class ReportSupplyCustom2 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void InitSupplyMainData()
        {
            ...
            this.itbSupplyMainCustom.supTotalPrice = this.itbSupplyMainCustom.supTotal -(this.itbSupplyMainCustom.supDscntAmount??0);
            this.itbSupplyMainCustom.supTotalFinal = (this.itbSupplyMain.supTotal + (this.itbSupplyMain.supTaxPrice??0)) - (this.itbSupplyMain.supDscntAmount??0);
        ...
        private void InitBranchImg(XRPictureBox control)
        {
            try
            {
                MemoryStream memoryStream = new MemoryStream(new ClsTblBranchImg().GetBranchImg(Session.CurBranch.brnId));

...
{
    public partial class ReportSalePurchaseDetailNew : DevExpress.XtraReports.UI.XtraReport
    {
        private short userId;
        private double total, totalTax, totalDiscount;
        IEnumerable<tblSupplyMain> tbSupplyMainList;

        public ReportSalePurchaseDetailNew()
        {
            InitializeComponent();
        ...
        private void ReportSalePurchaseMaster_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {

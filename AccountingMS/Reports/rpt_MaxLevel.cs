...
{
    public partial class rpt_MaxLevel : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_MaxLevel()
        {
            InitializeComponent();
            ...
            cell_ReorderLevel.ExpressionBindings.Add(new ExpressionBinding("BeforePrint", "Text", "[MaxLevel]"));
        ...
        {
            rpt_MaxLevel rpt = new rpt_MaxLevel();

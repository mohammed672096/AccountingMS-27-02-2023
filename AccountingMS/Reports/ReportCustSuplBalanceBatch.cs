...
{
    public partial class ReportCustomerSupplierBalanceBatch : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ReportCustomerSupplierBalanceBatch(byte status)
        {
            this.status = status;
            InitializeComponent();
            InitDefaultData();
        ...
        private void InitDefaultData()
        {
            ...
            {
                parameterDtStart.Description = "From";
                parameterDtEnd.Description = "To";
            }

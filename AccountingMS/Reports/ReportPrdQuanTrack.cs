...
namespace AccountingMS
{
    public partial class ReportPrdQuanTrack : XtraReport
    {
        ...
        private void XrtcTrcStatus_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            XRTableCell cell = sender as XRTableCell;
            cell.Text = ClsPrdTrackingStatus.GetString(Convert.ToByte(cell.Value));
        }

        private void XrtcTrcPrdMsurId_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            XRTableCell cell = sender as XRTableCell;

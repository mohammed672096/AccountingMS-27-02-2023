...
{
    public partial class ReportSaleGroupRollHead : XtraReport
    {
        ReportSaleGroupMasterRoll reportSaleGroupMaster;
        ...
        public ReportSaleGroupRollHead()
        {
            InitializeComponent();
        ...
        {
            this.reportSaleGroupMaster = new ReportSaleGroupMasterRoll(this.clsTbUser, this.clsTbGroup);

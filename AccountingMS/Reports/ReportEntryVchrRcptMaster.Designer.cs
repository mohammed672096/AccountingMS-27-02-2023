...
{
    partial class ReportEntryVchrRcptMaster
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.xrtcEntryType = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.tblBoxParmBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.tblBoxBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.tblBankParmBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.tblBankBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ((System.ComponentModel.ISupportInitialize)(this.xrTable1)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.tblBoxParmBindingSource)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.tblBoxBindingSource)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.tblBankParmBindingSource)).BeginInit();
            ...
            this.xrTable1.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(73)))), ((int)(((byte)(80)))), ((int)(((byte)(87)))));
            this.xrTable1.Name = "xrTable1";
            this.xrTable1.Padding = new DevExpress.XtraPrinting.PaddingInfo(0, 0, 5, 5, 100F);
            ...
            // xrtcEntryType
            // 
            this.xrtcEntryType.Name = "xrtcEntryType";
            this.xrtcEntryType.Padding = new DevExpress.XtraPrinting.PaddingInfo(0, 0, 0, 0, 100F);
            this.xrtcEntryType.StylePriority.UseFont = false;
            this.xrtcEntryType.StylePriority.UsePadding = false;
            this.xrtcEntryType.StylePriority.UseTextAlignment = false;
            this.xrtcEntryType.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
            // 
            // xrtcInvoiceName
            // 
            this.xrtcInvoiceName.Multiline = true;
            this.xrtcInvoiceName.Name = "xrtcInvoiceName";
            this.xrtcInvoiceName.Padding = new DevExpress.XtraPrinting.PaddingInfo(0, 0, 0, 0, 100F);
            this.xrtcInvoiceName.StylePriority.UseFont = false;
            this.xrtcInvoiceName.StylePriority.UsePadding = false;
            this.xrtcInvoiceName.StylePriority.UseTextAlignment = false;
            this.xrtcInvoiceName.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
            // 
            // parameterBank
            // 
            this.parameterBank.MultiValue = true;
            this.parameterBank.Name = "parameterBank";
            this.parameterBank.Type = typeof(long);
            dynamicListLookUpSettings2.DataMember = null;
            dynamicListLookUpSettings2.DataSource = this.tblBankParmBindingSource;
            dynamicListLookUpSettings2.DisplayMember = "bankName";
            dynamicListLookUpSettings2.FilterString = null;
            dynamicListLookUpSettings2.SortMember = null;
            dynamicListLookUpSettings2.ValueMember = "bankAccNo";
            this.parameterBank.ValueSourceSettings = dynamicListLookUpSettings2;
            // 
            // tblBoxParmBindingSource
            // 
            this.tblBoxParmBindingSource.DataSource = typeof(AccountingMS.tblAccountBox);
            // 
            // tblBoxBindingSource
            // 
            this.tblBoxBindingSource.DataSource = typeof(AccountingMS.tblAccountBox);
            // 
            // tblBankParmBindingSource
            // 
            this.tblBankParmBindingSource.DataSource = typeof(AccountingMS.tblAccountBank);
            // 
            // tblBankBindingSource
            // 
            this.tblBankBindingSource.DataSource = typeof(AccountingMS.tblAccountBank);
            // 
            // ReportEntryVchrRcptMaster
            // 
            ...
            this.tblBoxParmBindingSource,
            this.tblBoxBindingSource,
            this.tblBankParmBindingSource,
            this.tblBankBindingSource});
            this.DataSource = this.tblBoxBindingSource;
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.parameterBank, "Default", "Description", "البنك:"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.ReportHeader, "Default", "HeightF", 63.75F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrlDate, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(504.9165F, 45.00001F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrlDate, "Default", "SizeF", new System.Drawing.SizeF(291.75F, 15F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrlHeader, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(252.948F, 110F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrlHeader, "Default", "SizeF", new System.Drawing.SizeF(302.0837F, 23.00001F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrlHeader, "Default", "Text", "تقرير سندات "),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrlHeader, "en", "Text", "Bond report"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrSubreport, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(10.00029F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrSubreport, "Default", "SizeF", new System.Drawing.SizeF(786.6662F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable1, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(10.00001F, 10.00001F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable1, "Default", "SizeF", new System.Drawing.SizeF(786.9166F, 35F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableRow3, "Default", "Weight", 1D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrtcEntryType, "Default", "Font", new DevExpress.Drawing.DXFont("Segoe UI Semibold", 15F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrtcEntryType, "Default", "Text", "كشف سندات "),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrtcEntryType, "en", "Text", "Bonds disclosure"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrtcEntryType, "Default", "Weight", 0.47018958480681805D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrtcInvoiceName, "Default", "Text", "للفترة [Parameters.parameterDtStart!yyyy/MM/dd]  إلى [Parameters.parameterDtEnd!y" +
                    "yyy/MM/dd]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrtcInvoiceName, "en", "Text", "From [Parameters.parameterDtStart!yyyy/MM/dd]  To [Parameters.parameterDtEnd!yyyy" +
                    "/MM/dd]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrtcInvoiceName, "Default", "Weight", 1.5298104151931824D)});
            ...
            ((System.ComponentModel.ISupportInitialize)(this.tblBoxParmBindingSource)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.tblBoxBindingSource)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.tblBankParmBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource tblBoxParmBindingSource;
        private System.Windows.Forms.BindingSource tblBoxBindingSource;
        private DevExpress.XtraReports.UI.XRSubreport xrSubreport;
        private DevExpress.XtraReports.UI.ReportHeaderBand ReportHeader;
        private DevExpress.XtraReports.UI.XRTable xrTable1;
        private DevExpress.XtraReports.UI.XRTableRow xrTableRow3;
        private DevExpress.XtraReports.UI.XRTableCell xrtcEntryType;
        ...
        private System.Windows.Forms.BindingSource tblBankParmBindingSource;

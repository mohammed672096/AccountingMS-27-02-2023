...
{
    public partial class ReportSaleGroupMasterRoll : XtraReport
    {
        ClsTblUser clsTbUser;
        ClsTblGroupStr clsTbGroup;
        ReportSaleGroupRollDetail reportSaleGroupDetail;
        ...
        public ReportSaleGroupMasterRoll(ClsTblUser clsTbUser, ClsTblGroupStr clsTbGroup)
        {
            InitializeComponent();
        ...
        {
            this.reportSaleGroupDetail = new ReportSaleGroupRollDetail();

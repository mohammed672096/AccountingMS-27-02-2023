...
{
    public partial class ReportSaleGroupMaster : XtraReport
    {
        ClsTblUser clsTbUser;
        ClsTblGroupStr clsTbGroup;
        ReportSaleGroupDetail reportSaleGroupDetail;
        ...
        public ReportSaleGroupMaster(ClsTblUser clsTbUser, ClsTblGroupStr clsTbGroup)
        {
            InitializeComponent();
        ...
        {
            this.reportSaleGroupDetail = new ReportSaleGroupDetail();

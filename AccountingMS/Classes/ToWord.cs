...
namespace AccountingMS
{
    public class Currency
    {
        ...
        public Boolean IsCurrencyNameFeminine { get; set; } = false;
         public Boolean IsCurrencyPartNameFeminine { get; set; } = true;
    ...
    public class ToWord
    {
        ...
        /// <summary>
        /// Get Proper double Value
        /// </summary>
        /// <param name="decimalPart">double Part as a String</param>
        /// <returns></returns>
        private string GetDecimalValue(string decimalPart)
        {
            ...
            if (Currency. PartPrecision != decimalPart.Length)
            {
                ...
                {
                    decimalPart += "0"; //Fix for 1 number after double ( 10.5 , 1442.2 , 375.4 ) 
                }
        ...
        /// <summary>
        /// Eextract Interger and double parts
        /// </summary>
        ...
        public string ConvertToEnglish()
        {
            ...
            formattedNumber += (retVal != String.Empty) ? (_intergerValue == 1 ? Currency.Pound1En : Currency.Pound3En) : String.Empty;
            ...
            formattedNumber += (decimalString != String.Empty) ? " " + (_decimalValue == 1 ? Currency.Piaster1En : Currency.Piaster3En) : String.Empty;
        ...
        public string ConvertToArabic()
        {
            ...
            { // here we add currency name depending on _intergerValue : 1 ,2 , 3--->10 , 11--->99
                ...
                if (remaining100 == 0)
                    formattedNumber += Currency.Pound1;
                else
                    if (remaining100 == 1)
                    formattedNumber += Currency.Pound1;
                else
                ...
                {
                    if (_intergerValue == 2)
                        formattedNumber += Currency.Pound2;
                    else
                        formattedNumber += Currency.Pound1;
                }
                else
                            if (remaining100 >= 3 && remaining100 <= 10)
                    formattedNumber += Currency.Pound3;
                else
            ...
            { // here we add currency part name depending on _intergerValue : 1 ,2 , 3--->10 , 11--->99
                ...
                if (remaining100 == 0)
                    formattedNumber += Currency.Piaster1;
                else
                    if (remaining100 == 1)
                    formattedNumber += Currency.Piaster1;
                else
                        if (remaining100 == 2)
                    formattedNumber += Currency.Piaster2;
                else
                            if (remaining100 >= 3 && remaining100 <= 10)
                    formattedNumber += Currency.Piaster3;
                else
                                if (remaining100 >= 11 && remaining100 <= 99)
                    formattedNumber += Currency.Piaster3;
            }

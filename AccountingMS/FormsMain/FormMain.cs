...
namespace AccountingMS
{
    public partial class FormMain : RibbonForm
    {
        ...
        public static List<tblUserControl> UserControlList = new List<tblUserControl>();

        void InitiUserPermision()
        {
            var _resource2 = new ComponentResourceManager(typeof(Language.Form1En));
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Accounts,
                ucName = barButtonItemAccount.Name,
                ucCaption = barButtonItemAccount.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemAccount.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.AccountsBalance,
                ucName = barButtonItemAccountsBalance.Name,
                ucCaption = barButtonItemAccountsBalance.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemAccountsBalance.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.OpeningAccounts,
                ucName = barButtonItemAccountOpening.Name,
                ucCaption = barButtonItemAccountOpening.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemAccountOpening.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Bank,
                ucName = barButtonItemBank.Name,
                ucCaption = barButtonItemBank.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemBank.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Box,
                ucName = barButtonItemBox.Name,
                ucCaption = barButtonItemBox.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemBox.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Branch,
                ucName = barButtonItemBranches.Name,
                ucCaption = barButtonItemBranches.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemBranches.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.CloseBoxDaily,
                ucName = barButtonCloseBoxDaily.Name,
                ucCaption = barButtonCloseBoxDaily.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonCloseBoxDaily.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.OpenBoxDaily,
                ucName = barButtonOpenBoxDaily.Name,
                ucCaption = barButtonOpenBoxDaily.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonOpenBoxDaily.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.ReviewBoxDaily,
                ucName = barButtonReviewBoxDaily.Name,
                ucCaption = barButtonReviewBoxDaily.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonReviewBoxDaily.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.ControlPanel,
                ucName = barButtonItemControlPanel.Name,
                ucCaption = barButtonItemControlPanel.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemControlPanel.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Currency,
                ucName = barButtonItemCurrency.Name,
                ucCaption = barButtonItemCurrency.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemCurrency.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Customers,
                ucName = barButtonItemCustomer.Name,
                ucCaption = barButtonItemCustomer.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemCustomer.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.DefaultAccount,
                ucName = barButtonItemDefaultAccount.Name,
                ucCaption = barButtonItemDefaultAccount.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemDefaultAccount.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.DefaultSettings,
                ucName = barButtonItemDefaultSettings.Name,
                ucCaption = barButtonItemDefaultSettings.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemDefaultSettings.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.EmoVchrPhased,
                ucName = barButtonItemEmoVchrPhased.Name,
                ucCaption = barButtonItemEmoVchrPhased.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEmoVchrPhased.Name}.Caption"),
            }); UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Employees,
                ucName = barButtonItemEmployee.Name,
                ucCaption = barButtonItemEmployee.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEmployee.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.EmployeesVoucher,
                ucName = barButtonItemEmployeeVocher.Name,
                ucCaption = barButtonItemEmployeeVocher.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEmployeeVocher.Name}.Caption"),
            });


            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.EmpVchrOvrTm,
                ucName = barButtonItemEmpVchrOvrTm.Name,
                ucCaption = barButtonItemEmpVchrOvrTm.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEmpVchrOvrTm.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.EmpVchrTip,
                ucName = barButtonItemEmpVchrTip.Name,
                ucCaption = barButtonItemEmpVchrTip.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEmpVchrTip.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Entries,
                ucName = barButtonItemEntry.Name,
                ucCaption = barButtonItemEntry.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEntry.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.EntryPhased,
                ucName = barButtonItemEntryTarhel.Name,
                ucCaption = barButtonItemEntryTarhel.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEntryTarhel.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.EntryRcpt,
                ucName = barButtonItemEntryRecipt.Name,
                ucCaption = barButtonItemEntryRecipt.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEntryRecipt.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.EntryVoucer,
                ucName = barButtonItemEntryVocher.Name,
                ucCaption = barButtonItemEntryVocher.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemEntryVocher.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.PrdExpirateQuan,
                ucName = barButtonItemPrdExpirateQuan.Name,
                ucCaption = barButtonItemPrdExpirateQuan.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemPrdExpirateQuan.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.ExpiredProducts,
                ucName = barButtonItemPrdExpirate.Name,
                ucCaption = barButtonItemPrdExpirate.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemPrdExpirate.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.FinancialYear,
                ucName = barButtonItemFinancialYear.Name,
                ucCaption = barButtonItemFinancialYear.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemFinancialYear.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.FixedAsset,
                ucName = barButtonItemFixedAsset.Name,
                ucCaption = barButtonItemFixedAsset.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemFixedAsset.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.InvStoreDirect,
                ucName = barButtonItemInvStoreDirect.Name,
                ucCaption = barButtonItemInvStoreDirect.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemInvStoreDirect.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.InvStoreManual,
                ucName = barButtonItemInvStoreManual.Name,
                ucCaption = barButtonItemInvStoreManual.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemInvStoreManual.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.InvStoreSettlement,
                ucName = barButtonItemInvStoreSettlement.Name,
                ucCaption = barButtonItemInvStoreSettlement.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemInvStoreSettlement.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.OfferPrice,
                ucName = barButtonItemSalePriceOffer.Name,
                ucCaption = barButtonItemSalePriceOffer.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemSalePriceOffer.Name}.Caption"),
            }); UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.OrderExecution,
                ucName = barButtonItemOrderExecute.Name,
                ucCaption = barButtonItemOrderExecute.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemOrderExecute.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.OrderReceipt,
                ucName = barButtonItemOrderReceipt.Name,
                ucCaption = barButtonItemOrderReceipt.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemOrderReceipt.Name}.Caption"),
            });

            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.OrderVoucher,
                ucName = barButtonItemOrderVoucher.Name,
                ucCaption = barButtonItemOrderVoucher.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemOrderVoucher.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.PrdQuanTracking,
                ucName = barButtonItemPrdQuanTracking.Name,
                ucCaption = barButtonItemPrdQuanTracking.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemPrdQuanTracking.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.ProductData,
                ucName = bbiStoreProductsData.Name,
                ucCaption = bbiStoreProductsData.Caption,
                ucCaptionEn = _resource2.GetString($"{bbiStoreProductsData.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.ProductQuant,
                ucName = barButtonItemProductQuantity.Name,
                ucCaption = barButtonItemProductQuantity.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemProductQuantity.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Purchase,
                ucName = barButtonItemPurchase.Name,
                ucCaption = barButtonItemPurchase.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemPurchase.Name}.Caption"),
            });
            //UserControlList.Add(new tblUserControl()
            //{
            //    ucNo = (byte)UserControls.PurchaseDel,
            //    ucName = barButtonItemPurchaseDel.Name,
            //    ucCaption = barButtonItemPurchaseDel.Caption,
            //    ucCaptionEn = _resource2.GetString($"{barButtonItemPurchaseDel.Name}.Caption"),
            //});
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.PurchaseOrders,
                ucName = barButtonItemPurchaseOrders.Name,
                ucCaption = barButtonItemPurchaseOrders.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemPurchaseOrders.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.PurchasePhased,
                ucName = barButtonItemPurchaseAll.Name,
                ucCaption = barButtonItemPurchaseAll.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemPurchaseAll.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.PurchaseRtrn,
                ucName = barButtonItemPurchaseRtrn.Name,
                ucCaption = barButtonItemPurchaseRtrn.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemPurchaseRtrn.Name}.Caption"),
            });


            //UserControlList.Add(new tblUserControl()
            //{
            //    ucNo = (byte)UserControls.PurchaseRtrnDel,
            //    ucName = barButtonItemPurchaseRtrnDel.Name,
            //    ucCaption = barButtonItemPurchaseRtrnDel.Caption,
            //    ucCaptionEn = _resource2.GetString($"{barButtonItemPurchaseRtrnDel.Name}.Caption"),
            //});
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Reports,
                ucName = barMenuReports.Name,
                ucCaption = barMenuReports.Caption,
                ucCaptionEn = _resource2.GetString($"{barMenuReports.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Representative,
                ucName = barButtonItemRepresentative.Name,
                ucCaption = barButtonItemRepresentative.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemRepresentative.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Sale,
                ucName = barButtonItemSale.Name,
                ucCaption = barButtonItemSale.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemSale.Name}.Caption"),
            });
            //UserControlList.Add(new tblUserControl()
            //{
            //    ucNo = (byte)UserControls.SaleDel,
            //    ucName = barButtonItemSaleDel.Name,
            //    ucCaption = barButtonItemSaleDel.Caption,
            //    ucCaptionEn = _resource2.GetString($"{barButtonItemSaleDel.Name}.Caption"),
            //});
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.SalePhased,
                ucName = barButtonItemSaleAll.Name,
                ucCaption = barButtonItemSaleAll.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemSaleAll.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.SaleRtrn,
                ucName = barButtonItemSaleRtrn.Name,
                ucCaption = barButtonItemSaleRtrn.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemSaleRtrn.Name}.Caption"),
            });
            //UserControlList.Add(new tblUserControl()
            //{
            //    ucNo = (byte)UserControls.SaleRtrnDel,
            //    ucName = barButtonItemSaleRtrnDel.Name,
            //    ucCaption = barButtonItemSaleRtrnDel.Caption,
            //    ucCaptionEn = _resource2.GetString($"{barButtonItemSaleRtrnDel.Name}.Caption"),
            //});
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.StockTrans,
                ucName = bbiStockTrans.Name,
                ucCaption = bbiStockTrans.Caption,
                ucCaptionEn = _resource2.GetString($"{bbiStockTrans.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.StoreProducts,
                ucName = bbiStoreProducts.Name,
                ucCaption = bbiStoreProducts.Caption,
                ucCaptionEn = _resource2.GetString($"{bbiStoreProducts.Name}.Caption"),
            });

            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Store,
                ucName = barButtonItemStore.Name,
                ucCaption = barButtonItemStore.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemStore.Name}.Caption"),
            });
            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Suppliers,
                ucName = barButtonItemSupplier.Name,
                ucCaption = barButtonItemSupplier.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemSupplier.Name}.Caption"),
            });


            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.TaxDecaration,
                ucName = barButtonItemTaxDeclaration.Name,
                ucCaption = barButtonItemTaxDeclaration.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemTaxDeclaration.Name}.Caption"),
            });

            UserControlList.Add(new tblUserControl()
            {
                ucNo = (byte)UserControls.Users,
                ucName = barButtonItemUserRIght.Name,
                ucCaption = barButtonItemUserRIght.Caption,
                ucCaptionEn = _resource2.GetString($"{barButtonItemUserRIght.Name}.Caption"),
            });

            using (var db = new accountingEntities())
            {
                var userCon = db.tblUserControls.AsNoTracking().ToList();
                var userNew = UserControlList.Where(x => !userCon.Any(y => y.ucName == x.ucName)).ToList();
                db.tblUserControls.AddRange(userNew.OrderBy(x => x.ucNo));
                db.SaveChanges();
                var Con = db.tblControls.AsNoTracking().ToList();
                List<tblControl> tblControls = new List<tblControl>();
                UserControlList.Where(x => !(Con.Any(y => y.cntucNo == x.ucNo))).ToList().ForEach(x =>
                {
                    var c = new tblControl { cntucNo = x.ucNo, cntCaption = "عرض " + x.ucCaption, cntCaptionEn = "View " + x.ucCaptionEn, cntName = x.ucName };
                    if (c != null)
                        tblControls.Add(c);

                });
                db.tblControls.AddRange(tblControls);
                db.SaveChanges();
            }
        }
        //void InitiUserPermision()
        ...
        void empshow()
        {
            ...
            {
                var empseting = db.tblSettings.FirstOrDefault(x => x.ID == MySetting.DefaultSetting.ID && x.MachineName == MySetting.DefaultSetting.MachineName);

                if (empseting.emp == true)
                    barMenuEmployees.Enabled = true;
                else
                    barMenuEmployees.Enabled = false;
            }
            ...
            try
            {
                switch (name)
                {
                    ...
                    case "barButtonItemSupplier":
                        ...
                        break;
                    case "btnEmpSettings":
                        Master = new UC_EmpSetting();
                        tabpage = new XtraTabPage() { Text = _resource.GetString($"{name}.Caption"), Name = name };
                        break;
                    case "btnEmpFingerPrintDevice": //جهاز البصمة
                        frm = new AttLogs(); frm.ShowDialog(); return;
                    case "btnEmpAttendingLeaving": //	حضور وانصراف	
                        frm = new AttendingLeavingD(); frm.ShowDialog(); return;
                    case "btnEmpListVacations": //	لائحة اجازات					
                        frm = new AbcenceRegulationView(); frm.ShowDialog(); return;
                    case "btnEmpListOvertimeDelay": //	لائحة الاضافى والتأخير					
                        frm = new OvertimeAndDelayRegulationView(); frm.ShowDialog(); return;
                    case "btnEmpOfficialVacations": //	الاجازات الرسمية					
                        frm = new OfficialVacationView(); frm.ShowDialog(); return;
                    case "btnEmpShifts": //	الورديات					
                        frm = new ShiftView(); frm.ShowDialog(); return;
                    case "btnEmpSalaries": //	المرتبات					
                        frm = new cashingEmployee(); frm.ShowDialog(); return;
                    case "btnEmpJob": //	الوظيفة					
                        frm = new JobView(); frm.ShowDialog(); return;
                    case "btnEmpSection": //القسم						
                        frm = new DepartmentView(); frm.ShowDialog(); return;
                    case "btnEmpGroups": //المجموعات						
                        frm = new GroupView(); frm.ShowDialog(); return;
                    case "btnEmpPredecessor": //السلف						
                        frm = new ancestorW(); frm.ShowDialog(); return;
                    case "btnEmpRewards": //المكافأت						
                        frm = new frmRewards(); frm.ShowDialog(); return;
                    case "btnEmpDiscounts": //		خصومات				
                        frm = new frmDiscounts(); frm.ShowDialog(); return;
                    case "btnEmpVacations": //		الاجازات		
                        frm = new FormalHoliday(); frm.ShowDialog(); return;
                    case "RepComTotalSales": //		تقرير عمولة مندوب (اجمالى مبيعات)		
                        frm = new frmReptotalselmandob(); frm.ShowDialog(); return;
                    case "MostMovingSuppliersReportValue": //		تقرير الموردين الأكثر حركة حسب القيمة
                        frm = new ReportMostActiveSuppliers(); frm.ShowDialog(); return;
                    case "ReceivablesReconstructionReport": //		تقرير الموردين الأكثر حركة حسب القيمة
                        frm = new ReportReconstruction(); frm.Show(); return;
